...
class MenuViewTest(TestCase):
    def setUp(self):
        ...
        Menu.objects.create(title="Burger", price=80, inventory=100)
        Menu.objects.create(title="Soy", price=3, inventory=100)
        Menu.objects.create(title="Coke", price=10, inventory=100)
    ...
    def test_get_all(self):
        ...
        expected_menu_titles = ["Burger", "Soy", "Coke"]
